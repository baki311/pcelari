  ...
  <div class="container py-4 py-lg-5 my-4">
    <div class="row">
      ...
      <div class="text-end pt-4">
        <button class="btn btn-primary" type="prijava"><i class="ci-sign-in me-2 ms-n21"></i>Prijava</button>
    </div>
...
<div class="col-md-6 pt-4 mt-3 mt-md-0">
    ...
    <div class="row gx-4 gy-3">
      ...
      <div class="col-12 text-end">
          <button class="btn btn-primary" type="submit"><i class="ci-user me-2 ms-n1"></i>Registracija</button>
      </div>
  </div>
