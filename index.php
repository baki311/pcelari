                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p class="m-b-40">Ovde možete videti širok asortiman naših proivoda <br> za pčele i od
                                pčela. Krenimo odmah!!!</p>
            ...
            <li class="text-center">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Dobro došli u <br> PČELA-RADILICA PRODAVNICU</strong></h1>
                            <p class="m-b-40">Saznajte kako gajimo naše pčele, kako se proizvodi med i koje sve vrste
                                meda postoje. <br>Krenimo u obilazak!! </p>
            ...
            <li class="text-center">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Dobro došli u <br> PČELA-RADILICA PRODAVNICU</strong></h1>
                            <p class="m-b-40">Naučite postupak cedjenja meda i kako se skladišti.<br> Cedi med sa nama.
                            </p>
                ...
                <div class="col-lg-3 col-md-6 special-grid best-seller">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            ...
                            <div class="mask-icon">
                                <ul>
                                    <li><a href="#" data-toggle="tooltip" data-placement="right" title="Opširnije"><i
                                                class="fas fa-eye"></i></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="right" title="Uporedi"><i
                                                class="fas fa-sync-alt"></i></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="right"
                                            title="Dodaj na listu želja"><i class="far fa-heart"></i></a></li>
                                </ul>
                ...
                <div class="blog-box">
                    ...
                    <div class="blog-content">
                        <div class="title-blog">
                            <h3>ZNAŠ LI?</h3>
                            <p>Na svetu postoji više od 20.000 vrsta pčela, a u našem regionu ih ima 1000. Samo je sedam
                                vrsta medonosnih pčela, a ostale nazivamo solitarnim: ne žive u košnicama, već grade
                                gnezda za sebe i svoje potomke. Nisu opasne za ljude pa se preporučuje da na svoje
                                balkone ili u svoje vrtove posadimo medonosno cveće i začinsko bilje. Možemo da
                                izgradimo i mali hotel za pčele od bambusa ili trske kojim ćemo pomoći da osiguramo
                                njihovu budućnost. </p>
                        </div>
            ...
            <div class="col-md-6 col-lg-4 col-xl-4">
                <div class="blog-box">
                    ...
                    <div class="blog-content">
                        <div class="title-blog">
                            <h3>ZANIMLJIVOST!</h3>
                            <p>Najmanja pčela na svetu je patuljasta pčela (Trigona minima). Dugačka je oko 2,1 mm.
                                Himalajska medonosna pčela (Apis dorsata laboriosa) je najveća medonosna pčela na svetu.
                                Odrasle jedinke mogu dostići dužinu do 3cm. Najveća pčela je ( Megachile pluto) koja
                                može narasti do dužine od 39 mm. Pčela se kreće se brzinom od 20-28km/h, a ako je prazna
                                može se kretati u do 60km/h. Pčela se kreće se brzinom od 20-28km/h, a ako je prazna
                                može se kretati u do 60km/h .</p>
                        </div>
                ...
                <div class="blog-box">
                    ...
                    <div class="blog-content">
                        <div class="title-blog">
                            ...
                            <p>Osnovni i jedini zadatak matice u pčelinjoj zajednici je polaganje jaja. Obavljanje ove
                                funkcije zavisi od spoljašnjih uslova, jačine pčelinje zajednica, rezervi hrane i
                                starosti matice.Matice se razlikuju od trutova i pčela radilica po tome što imaju
                                izdužen zadnji deo tela, pa su joj krila primetno kraća u odnosu na telo. Poseduje
                                žaoku, ali je gotovo nikada ne upotrebljava da ubode pčelara, već joj služi za borbu sa
                                drugim maticama. U košnici opstaje samo jedna matica. </p>
                        </div>
