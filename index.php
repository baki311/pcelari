        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                    ...
                    <li class="nav-item"><a class="nav-link" href="contact-us.html">Kontaktirajte nas</a></li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
    ...
    <div class="side">
        ...
        <li class="cart-box">
            <ul class="cart-list">
                ...
                <li class="total">
                    <a href="cart.html" class="btn btn-default hvr-hover btn-cart">Pregledaj korpu</a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p><a class="btn hvr-hover" href="#">Kupovina</a></p>
                    </div>
                </div>
            </div>
        </li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p><a class="btn hvr-hover" href="#">Obilazak</a></p>
                    </div>
                </div>
            </div>
        </li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                       ...
                       <p><a class="btn hvr-hover" href="#">Cedjenje meda</a></p>
                   </div>
               </div>
           </div>
       </li>
...
<div class="instagram-box">
    <div class="main-instagram owl-carousel owl-theme">
        ...
        <div class="item">
            <div class="ins-inner-box">
                <img src="images/saceumedu3.jpeg" alt="" />
                <div class="hov-in">
                    <a href="#"><i class="fab fa-instagram"></i></a>
                </div>
            </div>
        ...
        <div class="item">
            <div class="ins-inner-box">
                <img src="images/kestenje.webp" alt="" />
                <div class="hov-in">
                    <a href="#"><i class="fab fa-instagram"></i></a>
                </div>
            </div>
        ...
        <div class="item">
            <div class="ins-inner-box">
                <img src="images/kestenov-med.jpg" alt="" />
                <div class="hov-in">
                    <a href="#"><i class="fab fa-instagram"></i></a>
                </div>
            </div>
        ...
        <div class="item">
            <div class="ins-inner-box">
                <img src="images/repica2.jpg" alt="" />
                <div class="hov-in">
                    <a href="#"><i class="fab fa-instagram"></i></a>
                </div>
            </div>
        ...
        <div class="item">
            <div class="ins-inner-box">
                <img src="images/kesten3.jpg" alt="" />
                <div class="hov-in">
                    <a href="#"><i class="fab fa-instagram"></i></a>
                </div>
            </div>
            ...
            <div class="row">
             <div class="col-lg-4 col-md-12 col-sm-12">
              <div class="footer-top-box">
               <h3>Radno vreme</h3>
               <ul class="list-time">
                <li>Ponedeljka - Petka: 08:00 - 17:00</li> <li>Subotom: 10:00 - 18.00</li> <li>Nedeljom: <span>Neradan dan</span></li>
            </ul>
        </div>
    </div>
    <div class="col-lg-4 col-md-12 col-sm-12">
      <div class="footer-top-box">
       <h3>Pošaljite nam poruku sa pitanjem ili zahtevom </h3>
       <form class="newsletter-box">
        <div class="form-group">
         <input class="" type="email" name="Email" placeholder="Email Address*" />
         <i class="fa fa-envelope"></i>
     </div>
     <button class="btn hvr-hover" type="submit">Pošalji</button>
 </form>
</div>
</div>
<div class="col-lg-4 col-md-12 col-sm-12">
  <div class="footer-top-box">
   ...
   <p>Možete nas pronaći i kontaktirati i na ovim društvenim mrežama.</p>
   <ul>
...
<div class="row">
    ...
    <div class="col-lg-4 col-md-12 col-sm-12">
        <div class="footer-link-contact">
            ...
            <ul>
                <li>
                    <p><i class="fas fa-map-marker-alt"></i>Adresa: Savski nasip 10 </p>
                </li>
                <li>
                    <p><i class="fas fa-phone-square"></i>Telefon: <a href="tel:+381 60 800 100">+381 60 800 100</a></p>
                </li>
                <li>
                    <p><i class="fas fa-envelope"></i>Email: <a href="mailto:contactinfo@gmail.com">stefanbalac000@gmail.com</a></p>
                </li>
            </ul>
        </div>
    </div>
